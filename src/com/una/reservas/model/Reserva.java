...
/**
 * Reserva de recursos hecha por un funcionario para una actividad.
 *
 * Las referencias a Funcionario, Categoria y Recurso se guardan por id
 * (idFuncionario, idsCategoriasRequeridas, idsRecursosAsignados), no como
 * objetos embebidos, para evitar duplicar datos en el XML. Ver la nota sobre
 * referencias entre entidades en docs/01_model.md. Los campos funcionario,
 * categoriasRequeridas y recursosAsignados (objetos completos) son transient
 * para JAXB y los resuelve la capa de service, no persistence.
 *
 * La regla de negocio de que recursosAsignados debe tener exactamente un
 * recurso por cada categoria requerida, y que solo se llena tras el exito
 * de intentarReservar, vive en ReservaService (ver docs/02_service.md), no aqui.
 */
...
public class Reserva {
    ...
    /**
     * Objeto Funcionario completo, resuelto por service a partir de idFuncionario.
     */
    ...
    /**
     * Objetos Categoria completos, resueltos por service a partir de idsCategoriasRequeridas.
     */
    ...
    /**
     * Objetos Recurso completos, resueltos por service a partir de idsRecursosAsignados.
     * Solo se llenan tras el exito de intentarReservar.
     */
